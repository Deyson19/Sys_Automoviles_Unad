...
public class ErroresSistema {
    ...
    private static ErroresSistema instanciaErrores;

    public static ErroresSistema getInstanciaErrores() {
        return instanciaErrores;
    }
    private ErroresSistema() {
    }
    ...
    /*public void insertarError(ErroresSistema error) {
        try {
            ...
            ConexionLocal cnLocal = ConexionLocal.getInstancia();
